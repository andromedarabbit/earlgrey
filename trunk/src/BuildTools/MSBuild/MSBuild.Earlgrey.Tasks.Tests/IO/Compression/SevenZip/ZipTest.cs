...
using MSBuild.Earlgrey.Tasks.IO.Compression.SevenZip;
using NUnit.Framework;

namespace MSBuild.Earlgrey.Tasks.Tests.IO.Compression.SevenZip
{
    [TestFixture]
    public class ZipTest
    {
        ...
        public void PackWithExcludePatterns()
        {
            ...
            Assert.IsTrue(HasSuchFiles(unzipRootDirExpected, "SevenZipPack.msbuild.xml"));
        }
