========================================================================
    정적 라이브러리 : Earlgrey.GTest 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 Earlgrey.GTest 라이브러리를 만들었습니다.

이 파일에는 Earlgrey.GTest 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.


Earlgrey.GTest.vcproj
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 Earlgrey.GTest.pch와
