...
#define BUCKET_COUNT_OF_32KB 42
	...
	public:
		enum {POOL_COUNT = BUCKET_COUNT_OF_32KB };
		enum {POOL_MAX   = 0x8000-sizeof(MemoryBlock)+1};
	...
	private:
		...
		public:
			...
			MemoryBlock* PopMemoryBlock();
			void PushMemoryBlock(MemoryBlock* InMemoryBlock);
