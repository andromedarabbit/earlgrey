...
namespace Earlgrey
{
	...
	// methods for controlled operation:
	  ...
	  void  update     (const BYTE *input, unsigned int input_length);
	...
	// the MD5 context.
	  MD5              (BYTE *string); // digest string, finalize
	...
	// last, the private methods, mostly static:
	  ...
	  void transform        (const BYTE *buffer);  // does the real update work.  Note 
