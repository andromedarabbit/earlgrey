...
#include "SlabAllocator.h"
 ...
 namespace Earlgrey
 {
 	...
 	public:
 		...
 		void* Alloc(typename Allocator::size_type bytes);
 		void* Realloc(void* ptr, DWORD bytes);
 		void Free(void * ptr);
	...
	template<class Allocator, class ThreadInterface>
	ThreadLocalAllocator<Allocator, ThreadInterface>::ThreadLocalAllocator()
	{
	...
	template<class Allocator, class ThreadInterface>
	inline void* ThreadLocalAllocator<Allocator, ThreadInterface>::Alloc(typename Allocator::size_type bytes)
	{
	...
	template<class Allocator, class ThreadInterface>
	inline void* ThreadLocalAllocator<Allocator, ThreadInterface>::Realloc(void* ptr, DWORD bytes)
	{
		INT tid = ThreadInterface::ThreadIndex();
	...
	template<class Allocator, class ThreadInterface>
	inline void ThreadLocalAllocator<Allocator, ThreadInterface>::Free(void * ptr)
	{
		INT tid = ThreadInterface::ThreadIndex();
	...
	template<class Allocator, class ThreadInterface>
	void ThreadLocalAllocator<Allocator, ThreadInterface>::DumpLog(/* Output */)
	{
